...
const Page = () => {
  ...
  const onDropRejected = (rejectedFiles: FileRejection[]) => {
    ...
    setIsDragOver(false)
    toast.error(`${file.file.type} el tipo no es soportado`);
  };
            ...
            <div
              ...
              <div className="flex flex-col justify-center mb-2 text-sm text-zinc-700">
                {isUploading ? (
                  ...
                  <div className="flex flex-col items-center">
                    <p>Redirigiendo, Espere por favor...</p>
                  </div>
                ) : isDragOver ? (
                  <p>
                    <span className="font-semibold mr-1">Soltar Archivo</span>
                    para subir
                  </p>
                ) : (
                  <p>
                    <span className="font-semibold mr-1">Click para subir</span>
                    o arrastra y suelta
                  </p>
                )}
              </div>
